...
public final class CameraManager {
  ...
  public com.google.zxing.client.android.camera.open.OpenCamera getOpenCamera() {
    return openCamera;
  }
   ...
   */
  public synchronized void openDriver(SurfaceTexture holder, int width, int height)
      throws IOException {
    ...
    theCamera.getCamera().setPreviewTexture(holder);
